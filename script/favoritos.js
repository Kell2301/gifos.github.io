"use strict";
const apiKey_fav = "XGSt7kcxD9MUFO07xzU7J203XNPURke4";
...
function maxGifMobileFav(img, id, slug, user, title) {
  if (window.matchMedia("(max-width: 1023px)").matches) {
    ...
    <button class="modal-btn-close" onclick="cerrarModalMobileFav()"><img src="./assets/close.svg" alt=""></button>
...
function borrarFavMaxMob(gif) {
  let iconNoFavMaxMob = document.getElementById(
    "icon-borrar-fav-max-mobile-" + gif
  );
...
function maxGifDesktopFav(img, id, slug, user, title) {
  if (window.matchMedia("(min-width: 1023px)").matches) {
    ...
    <button class="modal-btn-close" onclick="cerrarModalDesktopFav()"><img src="./assets/close.svg" alt=""></button>
    <img src="${img}" alt="${id}" class="modal-gif">
